...
void S9xStartScreenRefresh ()
{
    ...
    if (IPPU.RenderThisFrame)
    {
		...
		{
            fprintf(stderr, "littlehui  S9xStartScreenRefresh 547 line IPPU.RenderedScreenWidth 512 called\n");
		...
		{
            fprintf(stderr, "littlehui S9xStartScreenRefresh 586 line IPPU.RenderedScreenWidth 256 called\n");
		...
		{
            //fprintf(stderr, "littlehui S9xStartScreenRefresh 596 line IPPU.RenderedScreenWidth 256 called\n");
