...
#define SAL_INPUT_INDEX_L2			2
#define SAL_INPUT_INDEX_R2		3
#define SAL_INPUT_INDEX_L3		4
#define SAL_INPUT_INDEX_R3		5
#define SAL_INPUT_INDEX_QUICK_SAVE		12
#define SAL_INPUT_INDEX_QUICK_LOAD		13
#define SAL_INPUT_INDEX_QUICK_QUIT		14
...
#define SAL_INPUT_QUICKLOAD		(1<<SAL_INPUT_INDEX_QUICK_LOAD)
#define SAL_INPUT_QUICKSAVE		(1<<SAL_INPUT_INDEX_QUICK_SAVE)
#define SAL_INPUT_QUITE_GAME	(1<<SAL_INPUT_INDEX_QUICK_QUIT)
#define SAL_INPUT_L2		(1<<SAL_INPUT_INDEX_L2)
#define SAL_INPUT_R2		(1<<SAL_INPUT_INDEX_R2)
#define SAL_INPUT_L3		(1<<SAL_INPUT_INDEX_L3)
#define SAL_INPUT_R3		(1<<SAL_INPUT_INDEX_R3)
